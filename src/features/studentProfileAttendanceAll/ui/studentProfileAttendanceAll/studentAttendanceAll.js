...
export const StudentAttendanceAll = () => {
    const dispatch = useDispatch();
    const attendanceData = useSelector(getAllAttendancesData);
    ...
    useEffect(() => {
            ...
            dispatch(studentProfileAttendanceAllDataThunk(lastId));
    ...
    useEffect(() => {
        if (selectedMonth && selectedYear) {
            dispatch(studentProfileAttendanceAllDataPostThunk({
                lastId,
                data: {year: +selectedYear, month: +selectedMonth}
            }));
        }
    }, [selectedYear, selectedMonth, dispatch, lastId]);
    ...
    const onHandleSubmit = async (month) => {
        ...
        dispatch(studentProfileAttendanceAllDataPostThunk({id: lastId, data}));
    };
